...
REM 开始记录日志
echo ======================================== > "%LOG_FILE%"
echo    小久任务管理系统 v4.2.3 Git部署    >> "%LOG_FILE%"
echo ======================================== >> "%LOG_FILE%"
...
if %errorlevel% neq 0 (
    ...
    REM 创建README.md文件
    echo # 小久任务管理系统 v4.2.3 > README.md
    git add README.md >> "%LOG_FILE%" 2>&1
    git commit -m "📝 初始提交" >> "%LOG_FILE%" 2>&1
    
    REM 再次添加所有文件
    git add . >> "%LOG_FILE%" 2>&1
    git commit -m "✨ 更新任务管理系统到v4.2.3版本" >> "%LOG_FILE%" 2>&1
)
