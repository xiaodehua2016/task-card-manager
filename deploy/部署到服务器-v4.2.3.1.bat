...
REM 开始记录日志
echo ======================================== > "%LOG_FILE%"
echo    小久任务管理系统 v4.2.3 手动部署    >> "%LOG_FILE%"
echo ======================================== >> "%LOG_FILE%"
...
echo 📋 部署步骤:
echo 1. 上传文件:
echo    - 将 task-manager-v4.2.3-complete.zip 上传到服务器
echo    - 可使用宝塔面板文件管理器或FTP工具
echo.
echo 2. 服务器操作 (通过宝塔面板终端或SSH):
echo    cd /www/wwwroot/
echo    unzip -o task-manager-v4.2.3-complete.zip -d task-manager/
...
echo    - 文件管理 → 上传 task-manager-v4.2.3-complete.zip
